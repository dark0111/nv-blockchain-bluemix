...
var options = 	{
					...
					chaincode:{
						zip_url: 'https://github.com/dark0111/nv-chaincode-local/archive/master.zip',
						unzip_dir: 'nv-chaincode-local-master',									//subdirectroy name of chaincode after unzipped
						git_url: 'https://github.com/dark0111/nv-chaincode-local',			//GO git http url
...
function cb_deployed(e, d){
	if(e != null){
		...
		wss = new WebSocketServer({server: server});												//start the websocket now
